...
class UniqueImages {
    ...
    public static class Image {
        ...
        public boolean equals(Object other) {
        	Image o=null;
//Vinod Paliwal: Before type casting to Image type we should do instance of check to make sure that other can be type cast in Image type.        	
...
//Vinod Paliwal:  If other is not of type Image then don`t check any value and return false.        	
        	}else {
